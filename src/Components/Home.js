    ...
    <div style={styles.container}>
      ...
      <div style={styles.buttonRow}>
        <Link to="/counter" style={styles.button}>
          <span style={styles.buttonText}>Counter</span>
        </Link>
        <Link to="/toggle" style={styles.button}>
          <span style={styles.buttonText}>toggle</span>
        </Link>
        <Link to="/form" style={styles.button}>
          <span style={styles.buttonText}>Form</span>
        </Link>
        <Link to="/about" style={styles.button}>
          <span style={styles.buttonText}>About</span>
        </Link>
        <Link to="/about" style={styles.button}>
          <span style={styles.buttonText}>About</span>
        </Link>
        ...
        <Link to="/another" style={styles.button}>
          <span style={styles.buttonText}>Another</span>
        </Link>
      </div>
    </div>
  );
